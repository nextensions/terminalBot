...
ENV NODE_VERSION=v9.4.0 NPM_VERSION=2.14.12 TITLE=NODEJS_BOT_NOTIFYHEAP_HIGH=70 MEM_HIGH=30 SH_OS=Y
...
WORKDIR /nodejs
RUN npm install dotenv moment moment-timezone pg request fs path node-schedule --save
